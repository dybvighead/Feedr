...
<body>
	...
	<div>
		<form onsubmit="return checkPassword(this)" action="addUser" method="post">
			<p><input type="text" name="firstName" placeholder="First name" value="${user.firstName}" required>
			<p><input type="text" name="lastName" placeholder="Last name" value="${user.lastName}" required>
			<p><input type="text" name="email" placeholder="Email Address" value="${user.email}" required>
			<p><input type="text" name="username" placeholder="Username" value="${user.username}" required >
			...
			<p> ${registrationError}, please try again
